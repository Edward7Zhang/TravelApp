...
public class AMapNavi_View extends Activity implements AMapNaviListener,AMapNaviViewListener {
    ...
    NaviLatLng mStartLatlng= new NaviLatLng(MainActivity.Latitude, MainActivity.Longitude);
    NaviLatLng mEndLatlng= new NaviLatLng(MainActivity.inLatitude, MainActivity.inLongitude);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amapnaviview);
